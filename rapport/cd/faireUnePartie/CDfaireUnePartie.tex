                      ...
                      \sialorssinon{i=j}
                                   {
                                     ...
                                     \instruction{poserPion(pos,pion,plateau)}
                                   }
                                   {
                                     \affecter{pion}{creerPion(noir())}
                                     \affecter{pos}{position(i,j)}\\
                                     \instruction{poserPion(pos,pion,plateau)}
                                   }
                    }
...
\begin{algorithme}
  \small
  \procedure{etatPartie}{\paramEntree{plateau : \textbf{Plateau}}, \paramEntreeSortie{couleur: \textbf{Couleur}}, \paramEntreeSortie{etat: \textbf{EtatPartie}}}
            {
              scoreBlanc: \entier
              scoreNoir: \entier
            }
...
\begin{algorithme}
  ...
  \procedure
  {faireUnePartie}
  {\paramEntree{obtenirCoupBlanc,obtenirCoupNoir : \textbf{ObtenirCoupEnFctDuJoueur}}, \paramEntree{sortie : \textbf{Sortie}} \paramSortie{couleurGagnant: \textbf{Couleur}}, \paramSortie{etat : \textbf{EtatPartie}}}
  {
