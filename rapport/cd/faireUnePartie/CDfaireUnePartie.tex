\begin{algorithme}
  ...
  \fonction
      ...
      { 
        \affecter{p}{plateau()}
        poserPion(p,Position(3,3),creerPion(BLANC))\\
        poserPion(p,Position(3,4),creerPion(NOIR))\\
        poserPion(p,Position(4,3),creerPion(NOIR))\\
        poserPion(p,Position(4,4),creerPion(BLANC))\\
             \retourner{p}
      }
\end{algorithme}
