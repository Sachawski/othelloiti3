	...
	{	\instruction{jouer(unPlateau,unCoup)}
		\sialorssinon{plateauTotalementRempli(unPlateau) ou plateauBloque(unPlateau) ou profondeur = 0}
		{
	...
	{\naturel}
	{compteur : \textbf{Naturel}, i,j : \textbf{1..8}, pos : \textbf{Position}}
	{\affecter{compteur}{0}
	...
	{\booleen}
	{}
	{\retourner{plateauBloquePourUneCouleur(unPlateau,couleurNoir()) et plateauBloquePourUneCouleur(unPlateau,couleurBlanc())}
	}
